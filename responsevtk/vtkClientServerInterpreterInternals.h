#pragma once
#ifndef _VTKCLIENTSERVERINTERPRETERINTERNALS_H
#define _VTKCLIENTSERVERINTERPRETERINTERNALS_H
...
class vtkClientServerInterpreterInternals : public vtkCommand
{
public:
	static vtkClientServerInterpreterInternals *New();

	//vtkClientServerInterpreterInternals();
	~vtkClientServerInterpreterInternals();
	void Execute(vtkObject* caller,unsigned long eventId,void* vtkNotUsed(callData)) VTK_OVERRIDE;
	int NewObserver();
public:
